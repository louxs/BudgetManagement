 ...
 */
public class CustomAdapterForBudgetList extends RecyclerView.Adapter<CustomAdapterForBudgetList.ViewHolderC> {
    private final List<CompteBancaire> listeComptes;
    ...
    public CustomAdapterForBudgetList(Context context,  List<CompteBancaire> listeComptes) {
    ...
    public void onBindViewHolder(ViewHolderC viewHolder, int i) {
        ...
        if(color==true)
            ...
            viewHolder.linearLayout.setBackgroundColor(context.getResources().getColor(R.color.colorItemList));
        color=!color;
