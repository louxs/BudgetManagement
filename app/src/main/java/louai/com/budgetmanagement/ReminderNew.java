...
public class ReminderNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Rappel");
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_return_activ);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        //// TODO: 19/08/2016 getParcelablelObject , if exist , supprimer button setvisible true -------- 
