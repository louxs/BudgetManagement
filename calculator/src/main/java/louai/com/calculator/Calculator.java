    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("recult", mResultEditText.getText().toString());
                Log.d("zone", mFormulaEditText.getText().toString());
                try {
                    Double.parseDouble(mFormulaEditText.getText().toString());
                    //// TODO: 20/08/2016 start activity for result and return result if its true  * completed
                    text.setText(mFormulaEditText.getText().toString());
                    finish();
                } catch (Exception e){
                    CharSequence text = "Valeur invalide!";
